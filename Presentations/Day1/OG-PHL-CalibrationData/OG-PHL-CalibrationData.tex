...
\begin{frame}
  ...
  \begin{frame}
    \centering
  \begin{tikzpicture}
    \node at (8,2.5) {\includegraphics[width=3cm]{./images/UN_logo.png}};
    \node at (3,3) {\includegraphics[width=3cm]{./images/WB_logo.png}};
    \node[rotate=10] at (6,0) {\includegraphics[width=3cm]{./images/IMF_logo.jpg}};
    \node[rotate=0] at (3,2) {\includegraphics[width=3cm]{./images/NTA_logo.png}};
    \node[rotate=30] at (5,1.2) {\includegraphics[width=3cm]{./images/WID_logo.png}};
    \node[rotate=-30] at (3,0) {\includegraphics[width=3cm]{./images/UNU-Wider_logo.jpg}};
  \end{tikzpicture}
\end{frame}
    ...
    \begin{frame}{Labor Productivity Profiles}
      \begin{itemize}
    ...
    \begin{frame}{Sectoral Production/Consumption Data}
      \begin{itemize}
        \item Production-Consumption Bridge
        \begin{itemize}
          \item Data from the \href{https://dataverse.harvard.edu/dataverse/IFPRI}{International Food Policy Research Institute} for Philippines
        \end{itemize}
        \item Consumption expenditure shares -- from same as above
      \end{itemize}
    \end{frame}
