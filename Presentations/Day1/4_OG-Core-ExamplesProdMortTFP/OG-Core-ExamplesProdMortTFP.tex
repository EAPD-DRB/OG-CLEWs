...
\section{Public Health and Macroeconomics}

  \begin{frame}
  \frametitle{The Macroeconomics of Public Health Spending}
    \begin{block}{}
      DeBacker, Jason, Richard Evans, and Marcelo LaFluer, ``The Economic Costs of Public Health Spending Cuts:
HIV/AIDS and Tuberculosis in South Africa'', \textit{Working Paper}, December, 2025.
    \end{block}
    \begin{itemize}
      \item Withdrawal of US aid to South Africa's HIV/TB programs leads to large economic costs
    \end{itemize}
  \end{frame}

  \begin{frame}{Forecasted Excess Deaths}
    \begin{figure}[htb]
    % \caption{Forecasted cumulative excess deaths in South Africa from US aid cuts}
    \label{fig:cumDeaths}
    \centering
    \includegraphics[scale=0.60]{./images/cumulative_excess_deaths.png}
\end{figure}
  \end{frame}

  \begin{frame}{GDP Effects of US Aid Cuts}
\begin{table}[htb] \centering \captionsetup{width=6.0in}
  ...
  \begin{tabular}{lrrr}
    ...
    rate & Brink (2025) &  Gandhi (2025) & KS (2025) \\
    \hline\hline
    1\% & \num{-447.83} & \num{-2,170.70} & \num{-5,017.78} \\
    2\% & \num{-525.35} & \num{-1,428.99} & \num{-2,917.75} \\
    3\% & \num{-472.10} & \num{-979.31} & \num{-1,811.36} \\
...
\end{table}
  ...
  \frametitle{The Macroeconomics of Improving Biological Aging}
    \begin{block}{}
      DeBacker, Jason, Richard Evans, and Raiany Romanni, ``The Macroeconomics of Improving Biological Aging'', \textit{Working Paper}, January, 2026.
    \end{block}
    \begin{itemize}
